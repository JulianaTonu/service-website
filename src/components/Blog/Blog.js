    ...
    <div class="container  ">
        ...
        <div class="p-4 text">
            <div class="p-4 mb-4 ques">
              <h5 className='text-primary font-bold'>1.Difference between SQL and NoSQL?</h5>
...
5.SQL databases are better for multi-row transactions, while NoSQL is better for unstructured data like documents or JSON.</p>
            ...
            <div class="p-4 mb-4 ques">
              <h5 className='text-primary font-bold'>2. What is JWT, and how does it work? </h5>
            ...
            <div class="p-4 mb-4 ques">
              <h5 className='text-primary font-bold'>3. What is the difference between javascript and NodeJS?  </h5>
              <p>Ans :NodeJS : 
...
Javascript is a Scripting language. It is mostly abbreviated as JS. It can be said that Javascript is the updated version of the ECMA script. Javascript is a high-level programming language that uses the concept of Oops but it is based on prototype inheritance.   
            ...
            <div class="p-4 mb-4 ques">
              <h5 className='text-primary font-bold'>4.How does NodeJS handle multiple requests at the same time?? </h5>
